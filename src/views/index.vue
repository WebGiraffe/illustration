        ...
        <div id="comments" class="clearfix">
            <div id="comments_left">
                <div>
                    ...
                    <div class="info1">
                        ...
                        <p class="p1">时间: &nbsp; 2018/10/10 10:49</p>
                    ...
                    <div class="viewPage_discuss">
                       <div class="discuss-text clearfix">
                            ...
                            <div class=" contentwrap clearfix">
                                <textarea id="texts" placeholder="有什么感想，你也来说说吧">
            ...
            <div id="comments_r">
                <div id="comments_right">
                    ...
                    <div class="rz">
                        <img src="img/v_2.png" alt="">
                        <span>{{user[0].renzheng}}</span>
                    </div> 
                    <div class="tool">
                    ...
                    <div class="ad_lunbo">
                        <a href="#" class="lubo"><img src="img/guanggao1.jpg" alt=""></a>
                        <a href="#" class="lubo"><img src="img/guanggao2.jpg" alt=""></a>
                        <a href="#" class="lubo"><img src="img/guanggao3.jpg" alt=""></a>
                        <a href="#" class="lubo"><img src="img/guanggao4.jpg" alt=""></a>
                    </div> 
...
<script>
    ...
    export default {
        ...
        created() {
            (async function(self){
                 var res=await self.$http.get("http://127.0.0.1:3000/img/user");
                self.user = res.data; 
           
                var res = await self.$http.get("http://127.0.0.1:3000/img/big");
                self.big = res.data; 
                
                var res = await self.$http.get("http://127.0.0.1:3000/img/bottom");
                self.bottom = res.data; 

                var res = await self.$http.get("http://127.0.0.1:3000/img/comment");
...
#index{height: 56px;;position: fixed;width:100%;box-shadow: 0 0px 2px rgba(0,0,0,.2);background: #1B1B1B;z-index:999;}
#header{display:flex;justify-content: space-between;margin:0 auto;width:1200px;}
