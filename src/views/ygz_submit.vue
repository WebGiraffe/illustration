            ...
            <div id="info">基本信息</div>
                <form class="layui-form" action="">
                    ...
                    <div class="layui-form-item" >
                      ...
                      <div class="layui-input-block">
                        <input type="radio"  name="style" title="填写风格" id="mystyle" >
                        <input type="radio"  name="style" title="风格不限" checked="">
                        <div class="container">
                    ...
                    <div class="layui-form-item layui-form-text">
                      ...
                      <div class="layui-input-block">
                        <textarea name="desc" placeholder="请输入内容" class="layui-textarea" rows="10" style="width:75%;"></textarea>
                      </div>
                    </div>
                    <div class="layui-form-item layui-form-text">
